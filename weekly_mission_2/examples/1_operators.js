...
NamesUpperCase.forEach(n => console.log(n))
...
P.forEach(char => console.log(char))
...
const countriesEndsByia = countries7.filter((country) => country.endsWith('ia')) // Small bug...
...
// Modified to with a different initialValue, for the banter
const numbers9 = [1, 2, 3, 4, 5]
const result_of_reduce = numbers9.reduce((acc, element) => acc + element, 10)
...
users.sort((a, b) => { // podemos invocar una función
    ...
    if (a.age < b.age) return -1 // a is sorted before b
    if (a.age > b.age) return 1 // b is sorted before a
    return 0
})

console.log("Ejemplo 16: Ordenando una lista de objetos por la edad de form ascendente")
console.log(users) // sorted ascending = true